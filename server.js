...
app.get('/api/weather', async (req, res) => {
  ...
  try {
    ...
    let apiUrl;
    if (city && country) {
      apiUrl = `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city},${country}?unitGroup=${unit}&key=${process.env.WEATHER_API_KEY}`;
    } else {
      apiUrl = `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${latitude},${longitude}?unitGroup=${unit}&key=${process.env.WEATHER_API_KEY}`;
    }
